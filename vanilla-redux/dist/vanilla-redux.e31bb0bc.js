...
var btnDecrease = document.querySelector('#decrease'); // 액션이름(타입)

var TOGGLE_SWITCHH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 액션생성함수
...
render();
store.subscribe(render); // dispatch: 액션(파라미터)을 발생시킴
